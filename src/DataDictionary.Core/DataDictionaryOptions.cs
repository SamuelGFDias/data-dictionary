...
/// <param name="SyncMode">The configured synchronization mode; defaults to <see cref="Configuration.SyncMode.Off"/>.</param>
/// <param name="OnBreakingChange">The configured breaking change policy; defaults to <see cref="Configuration.OnBreakingChange.Fail"/>.</param>
